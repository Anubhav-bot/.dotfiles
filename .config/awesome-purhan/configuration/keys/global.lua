...
awful.key({modkey}, 'c', function() awful.util.spawn_with_shell(apps.default.editor) end,
...
awful.key({modkey}, 'a', function() awful.spawn('fastanime anilist') end,
          {description = 'launch fastanime', group = 'launcher'}),
...
awful.key({modkey}, 'Return',
          function() awful.util.spawn(apps.default.terminal) end,
...
awful.key({altkey}, 'k', function() _G.toggle_quake() end,
...
awful.key({ modkey }, 't', function() toggleBarsVisibility() end,
